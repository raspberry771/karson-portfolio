type Blog = {
  ...
  image: string;
  imageAlt: string;
  slug: string; // used for linking to individual pages (optional)
};
...
const blogs: Blog[] = [
  ...
  },
  {
    ...
    date: "2025-10-11",
    description: "CSA ultraman day, went to pismo beach, played games, and went to an afterparty",
    image: "./image/ultraman.jfif",
